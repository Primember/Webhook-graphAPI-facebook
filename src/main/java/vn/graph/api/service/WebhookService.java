...
public class WebhookService {
    ...
    public void processMessage(String accessToken, String payload) {
        ...
        String url = String.format("https://graph.facebook.com/v16.0/me/messages?access_token=%s", accessToken);
    ...
    public void subscribeAppToPage() {
        ...
        String url = String.format("https://graph.facebook.com/v16.0/%s/subscribed_apps?access_token=%s",  PAGE_ID, PAGE_ACCESS_TOKEN);
